...
func TestHclFileUpdater_UpdateFile(t *testing.T) {
	tests := []struct {
		...
		{
			name:           "Update version with prerelease",
			fileContent:    "version = \"1.0.0\" # depup package=test-pkg\n",
			packages:       []Package{{Name: "test-pkg", Version: "1.2.3-beta.1"}},
			options:        FileUpdaterOptions{DryRun: false},
			expectedOutput: "version = \"1.2.3-beta.1\" # depup package=test-pkg\n",
			expectUpdated:  true,
			expectError:    false,
		},
		{
			name:           "Update version with build metadata",
			fileContent:    "version = \"1.0.0-rc.1\" # depup package=test-pkg\n",
			packages:       []Package{{Name: "test-pkg", Version: "1.2.3+build.789"}},
			options:        FileUpdaterOptions{DryRun: false},
			expectedOutput: "version = \"1.2.3+build.789\" # depup package=test-pkg\n",
			expectUpdated:  true,
			expectError:    false,
		},
		{
			name:           "Update version with prerelease and build metadata",
			fileContent:    "version = \"1.0.0-alpha.1\" # depup package=test-pkg\n",
			packages:       []Package{{Name: "test-pkg", Version: "1.2.3-beta.1+exp.sha.5114f85"}},
			options:        FileUpdaterOptions{DryRun: false},
			expectedOutput: "version = \"1.2.3-beta.1+exp.sha.5114f85\" # depup package=test-pkg\n",
			expectUpdated:  true,
			expectError:    false,
		},
		{
			name:           "No update needed with identical prerelease",
			fileContent:    "version = \"1.2.3-beta.1\" # depup package=test-pkg\n",
			packages:       []Package{{Name: "test-pkg", Version: "1.2.3-beta.1"}},
			options:        FileUpdaterOptions{DryRun: false},
			expectedOutput: "version = \"1.2.3-beta.1\" # depup package=test-pkg\n",
			expectUpdated:  false,
		...
		{
			name:           "Inline slash comment with prerelease",
			fileContent:    "  version = \"1.0.0\" // depup package=test-pkg\n",
			packages:       []Package{{Name: "test-pkg", Version: "1.0.1-rc.1"}},
			options:        FileUpdaterOptions{DryRun: false},
			expectedOutput: "  version = \"1.0.1-rc.1\" // depup package=test-pkg\n",
			expectUpdated:  true,
			expectError:    false,
		},
		{
			name:           "Inline hash comment with build metadata",
			fileContent:    "\tversion = \"1.0.0\" # depup package=test-pkg\n",
			packages:       []Package{{Name: "test-pkg", Version: "1.1.0+build.99"}},
			options:        FileUpdaterOptions{DryRun: false},
			expectedOutput: "\tversion = \"1.1.0+build.99\" # depup package=test-pkg\n",
			expectUpdated:  true,
			expectError:    false,
		},
		{
			name:           "Previous line comment with prerelease and indentation",
			fileContent:    "# depup package=test-pkg\n    version = \"1.2.3\"\n",
			packages:       []Package{{Name: "test-pkg", Version: "1.2.4-beta.2"}},
			options:        FileUpdaterOptions{DryRun: false},
		...
		{
			name:           "Previous line with both prerelease and buildmetadata",
			fileContent:    "// depup package=test-pkg\n  version = \"2.0.0\"\n",
			packages:       []Package{{Name: "test-pkg", Version: "2.0.1-alpha.1+build.001"}},
			options:        FileUpdaterOptions{DryRun: false},
			expectedOutput: "// depup package=test-pkg\n  version = \"2.0.1-alpha.1+build.001\"\n",
			expectUpdated:  true,
			expectError:    false,
		},
		{
			name:           "Non-matching package name with pre-release",
			fileContent:    "version = \"1.0.0\" // depup package=other-pkg\n",
			packages:       []Package{{Name: "test-pkg", Version: "1.0.1-beta.1"}},
			options:        FileUpdaterOptions{DryRun: false},
			expectedOutput: "version = \"1.0.0\" // depup package=other-pkg\n",
			expectUpdated:  false,
			expectError:    false,
		},
		{
			name:           "Already updated with same prerelease",
			fileContent:    "# depup package=test-pkg\nversion = \"3.4.5-alpha.1\"\n",
			packages:       []Package{{Name: "test-pkg", Version: "3.4.5-alpha.1"}},
			options:        FileUpdaterOptions{DryRun: false},
			expectedOutput: "# depup package=test-pkg\nversion = \"3.4.5-alpha.1\"\n",
			expectUpdated:  false,
			expectError:    false,
